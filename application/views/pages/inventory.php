                                    ...
                                    <tbody>
                                        <tr>
                                           <td>Laptop</td>
                                            ...
                                            <td>CO</td>
                                            <td>
                                                <a class="" data-toggle="modal" data-target="#addqty"><i class="fa fa-plus-circle" style="font-size:30px;color:  #0000CD;"></i></a>                                                <a class="" data-toggle="modal" data-target="#subqty"><span class="fa fa-minus-circle" style="font-size:30px;color:red;"></span></a>
                                                <a class=""><span class="fa fa-pencil-square-o" style="font-size:30px;color:#32CD32" data-toggle="modal" data-target="#edit"></span></a>
                                                <a class=""><span class="fa fa-info-circle" style="font-size:30px;color:    #B8860B;" data-toggle="modal" data-target="#itemdetails"></span></a>
